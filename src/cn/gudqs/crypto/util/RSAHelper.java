...
public class RSAHelper {
     ...
     * @throws Exception
     */
    public void loadPublicKeyPEMPKCS1(String publicKey) throws Exception {
        try {
            byte[] privBytes = Base64.decode(publicKey);
            ...
            X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(privateKeyPKCS1);
