...
public class RSAUtil {
     ...
     * 获取公钥的key
     */
    private static final String PUBLIC_MAP_KEY = "RSAPublicKey";

    /**
     * 获取私钥的key
     */
    private static final String PRIVATE_MAP_KEY = "RSAPrivateKey";
    ...
    public static Map<String, Object> genKeyPair() throws Exception {
        ...
        keyMap.put(PUBLIC_MAP_KEY, publicKey);
        keyMap.put(PRIVATE_MAP_KEY, privateKey);
        return keyMap;
    }
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
            throws Exception {
        Key key = (Key) keyMap.get(PRIVATE_MAP_KEY);
    ...
    public static String getPublicKey(Map<String, Object> keyMap)
            throws Exception {
        Key key = (Key) keyMap.get(PUBLIC_MAP_KEY);
        return Base64Util.encodeByte(key.getEncoded());
    }


    public static byte[] decryptPublic(byte[] data, org.bouncycastle.asn1.pkcs.RSAPublicKey rsaPublicKey) throws Exception {
